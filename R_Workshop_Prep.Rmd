...
6. Download the workshop files (right click to save): 
    ...
    + For day 1 <a href='https://github.com/jbhender/Workshops/tree/master/Intro_2_R/attitude.csv' > attitude.csv </a>
    + For day 1 (Intro to R) and day 3 (regression):
    <a href='https://jbhender.github.io/cars.csv' > cars.csv </a>
    + Rscript for day 2: <a href='./Day2_notes.R'> Day2_notes.R </a>
