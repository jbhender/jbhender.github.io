...
#setwd('~/Box\ Sync/CSCAR/IHPI-seminar/')
```
...
4. Create an 'Rworkshop' folder on your dekstop and move the data to that folder.
5. Open RStudio and set the working directory to the 'Rworkshop' folder you just created.
6. I will send workshop files on Thursday.
...
provides additional functionality and simplies many tasks. Make sure you install
...
5. Check that you were sucessful by typing `getwd()` in the console to the left.
