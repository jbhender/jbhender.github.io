...
#' author: "Henderson J, Wilkinson K, Hofer TP, Holleman R, Klamerus M, Bhatia RS, Kerr EA"
#' output: 
#'   html_document:
#'     code_folding: hide
#'     
...
#' ## About
#' This document provides supporting material for the publication
#' "Agreement Among Measures Examining Low-Value Imaging for Low Back Pain",
#' Am J Manag Care. 2021;27(10):000-000.  
#' 
#' ## Overview
...
#'  executable R script, [`eAppendixB.R`](./eAppendixB.R).
#' 
#' ## Tables
...
excl_cap = "**Table 1.** *Exclusion counts by measure combination.*"
...
#+ im_tab
im_cap = "**Table 2.** *Imaging counts by measure combination.*"
...
#+ num_tab
n0 = "**Table 3.** *Numerator counts by measure combination.* "
...
#+ kappa_tab
p_cap = "**Table 4.** Components of agreement statistics."
